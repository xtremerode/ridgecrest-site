...
export const metadata: Metadata = {
  title: "Texas Business Format Letter | Ridgecrest Designs",
  description: "Explore a clear, professional Texas business-letter format guide from Ridgecrest Designs—ideal for architects, remodelers and luxury home firms needing polished correspondence.",
  alternates: { canonical: "/tx-business-format-letter" },
};
